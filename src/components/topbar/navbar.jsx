  ...
  const closeMenu =() => setClick(false)
    return (
      ...
      <div className="navbar">        
          ...
          <Link to="" spy={true} smooth={true} offset={-100} duration={500} onClick ={closeMenu} className="desktopMenuListItem">About</Link>

          <Link to="pr" spy={true} smooth={true} offset={-100} duration={500} onClick ={closeMenu} className="desktopMenuListItem">Projects</Link>

          <Link to="rs" spy={true} smooth={true} offset={-100} duration={500} onClick ={closeMenu} className="desktopMenuListItem">Resume</Link>
